...
balance.apply_combat_modifiers = function(force)
  ...
  balance.script_data.config.modifier_list.force_modifiers.maximum_following_robot_count = math.max(balance.script_data.config.modifier_list.force_modifiers.maximum_following_robot_count, 1)

  for name, modifier in pairs (balance.script_data.config.modifier_list.force_modifiers) do
    force[name] = modifier
  end
